...
import { initializeAuthenticator, createCredential, handleGetAssertion, getAvailableCredentials } from './authenticator';
import { getPasskeysFromRenterd, downloadPasskeyFromRenterd, uploadPasskeyDirect } from './sia';
